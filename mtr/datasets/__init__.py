...
def build_dataloader(dataset_cfg, batch_size, dist, workers=4,
                     logger=None, training=True, merge_all_iters_to_one_epoch=False, total_epochs=0, add_worker_init_fn=False, updated_trajs=None, updated_frames=0, updated_scenario_id=None):
    ...
    dataset = __all__[dataset_cfg.DATASET](
        ...
        training=training,
        logger=logger,
        updated_trajs=updated_trajs,
        updated_frames=updated_frames,
        updated_scenario_id=updated_scenario_id
    )
