...
def decode_map_features_from_proto(map_features):
    ...
    for cur_data in map_features:
        ...
        # print(cur_info)
        # print(cur_data.lane.ByteSize())
        # print(cur_data.road_line.ByteSize())
        # print(cur_data.road_edge.ByteSize())
        # print(cur_data.stop_sign.ByteSize())
        # print(cur_data.crosswalk.ByteSize())
        # print(cur_data.speed_bump.ByteSize())
...
def process_waymo_data_with_scenario_proto(data_file, output_path=None):
    ...
    for cnt, data in enumerate(dataset):
        ...
        track_infos = decode_tracks_from_proto(scenario.tracks)     # Still in the original coordinate system

        waymo_resimulation_object_ids = submission_specs.get_sim_agent_ids(scenario)
        info['tracks_to_predict'] = {
            'track_index': [track_infos['object_id'].index(obj_id) for obj_id in waymo_resimulation_object_ids]     ## Updated to reflect the wosac list
...
def get_infos_from_protos(data_path, output_path=None, num_workers=1):
    ...
    src_files.sort()
    print("Length of sec_files: " + str(len(src_files)))
